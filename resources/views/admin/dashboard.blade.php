...
@php
    $tabs = [
        ...
        'stremio-catalog' => 'Stremio catálogo',
        'stremio-streams' => 'Stremio reproducción',
        'trials' => 'Crear prueba',
    ];
@endphp
...
@if ($section === 'overview')
    ...
    <section class="panel" style="margin-top:18px">
        ...
        <div class="actions"><a class="button primary" href="{{ route('admin.dashboard', ['section' => 'stremio-catalog']) }}">Administrar catálogo</a><a class="button" href="{{ route('admin.dashboard', ['section' => 'stremio-streams']) }}">Administrar reproducción</a></div>
    </section>
